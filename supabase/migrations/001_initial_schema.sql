...
CREATE TABLE accounts (
  ...
  satisfaction_score_q1 INTEGER CHECK (satisfaction_score_q1 BETWEEN 1 AND 10),
  satisfaction_score_q2 INTEGER CHECK (satisfaction_score_q2 BETWEEN 1 AND 10),
  satisfaction_score_q3 INTEGER CHECK (satisfaction_score_q3 BETWEEN 1 AND 10),
  satisfaction_score_q4 INTEGER CHECK (satisfaction_score_q4 BETWEEN 1 AND 10),
